...
\begin{theorem}
  \label{thm:G_ord_G}
  \uses{thm:ord_G, thm:ord_pow_ord, thm:coeff_mul_ord}
...
\begin{theorem}
  \label{Filtration_Theta_pow_sub_one}
...
\begin{theorem}
  ...
  \uses{def:G, thm:ord_pow_ord, thm:ord_Delta, lem:fl_delta_add_one, thm:Eis_two_one}
