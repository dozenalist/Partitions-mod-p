...
\begin{definition} [Filtration]
  ...
  The filtration of the zero function is $0$.F
\end{definition}
...
\begin{definition}
  ...
  \[G_{k,\: c} = E_2 ^ a E_3 ^ b E_2 ^ {k / 2 - 3c} \Delta ^ c \]
  where $a, b$ are the minimal natural numbers such that $2a + 3b \equiv k \pmod 6$. \\
