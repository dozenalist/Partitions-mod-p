...
\begin{theorem}
  ...
  \lean{thm:Filt_Theta_pow_l_sub_one}
  \leanok
...
\begin{theorem}
  ...
  \uses{lem:Filt_fl, thm:Filtration_Log, lem:const_of_Filt_zero, thm:U_pow_l_eq_self_sub_Theta_pow_l_sub_one, lem:Filt_fl}
  \lean{Filt_U_pos}
  \leanok
