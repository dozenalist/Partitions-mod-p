...
\begin{theorem}[Pow Prime] 
  \label{thm:Pow_Prime}
  \uses{def:mulpow, lem:non_diag_vanish, lem:prod_eq_of_perm_equiv, lem:non_const_of_tuple}
  \lean{Pow_Prime}
  \leanok
...
\begin{lemma}
  \label{lem:Filt_fl}
  \uses{thm:Filtration_Log, def:fl}
  \lean{Filt_fl}
  \leanok
...
\begin{theorem}
  \label{thm:ord_mul_ord}
  \uses{thm:ord_mul}
  \lean{Integer.ord_mul_ord}
  \leanok
...
\begin{theorem}
  \label{thm:G_ord_G}
  \uses{thm:ord_G, thm:ord_pow_ord, thm:ord_mul_ord}
  \lean{Integer.G_ord_G}
  \leanok
  $G_{k,\, c} (c) = 1$.
\end{theorem}
\begin{proof}
...
\begin{theorem}
  \label{thm:zero_of_leading_zeros}
  \uses{def:G, thm:ord_G, def:dim}
  \lean{Integer.zero_of_leading_zeros}
  \leanok
  Let $a$ be a modular form of weight $2k$. If ord$(a) \: \ge \: $dim$(k)$ then $a$ is the zero function.
\end{theorem}
\begin{proof}
  \leanok
\end{proof}
...
\begin{theorem}
  ...
  \uses{thm:zero_of_leading_zeros, thm:G_ord_G}
  \lean{Integer.eq_G_of_ord_max}
  \leanok
...
\begin{theorem}
  ...
  \uses{thm:G_ord_G, thm:Filtration_congruence}
  \lean{Modulo.exists_maximal_Reduce}
  \leanok
...
\begin{theorem}
  ...
  \uses{def:fl, thm:Filtration_congruence, thm:exists_maximal_Reduce, thm:zero_of_leading_zeros}
...
\begin{lemma}
  ...
  \uses{def:fl, def:mulpow, lem:non_diag_vanish} 
...
\begin{theorem}
  ...
  \lean{DeltaProduct_eventually_sum}
  \leanok
...
\begin{theorem}
  ...
  \lean{fl_Product_eventually_sum}
  \leanok
...
\begin{theorem} 
  ...
  \uses{def:U_Operator, def:ramanujan_congruence, thm:fl_Product_eventually_sum, 
...
\begin{theorem}
  ...
  \uses{def:fl, thm:exists_maximal_Reduce, thm:eq_G_of_ord_max, 
    thm:zero_of_leading_zeros, thm:Filt_Theta_l_add_three_div_two}
